...
subtitle: "EDA 1 - Books of Ukraine Dataset"
...
Following the **FIDES framework**, we develop analytical insights in the companion `.R` script before publishing them here (in the QMD document) for broader consumption.
...
```{r}
#| label: g11
#| code-summary: Annual print run (circulation) trends
#| code-fold: true
#| eval: true
#| cache: true
#| fig-cap: "Total circulation (number of copies printed) in Ukraine by year (2005-2023)"
```
