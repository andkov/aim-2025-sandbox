...
- **Root-level `.ps1` files**: Bootstrapping/setup scripts (e.g., `setup-nodejs.ps1`)
...
See `ai/personas/developer.md` → "PowerShell Scripting Standards" for complete guidelines.
